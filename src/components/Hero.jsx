      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-80px)] max-w-7xl items-center gap-8 px-5 py-12 sm:px-6 md:py-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-4 lg:px-8 lg:py-20">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-base leading-7 text-text-secondary sm:text-lg sm:leading-8">
            Farm-fresh dairy made for your everyday table.
            Discover our buffalo milk and other dairy products,
            with simple local ordering and delivery.
          </p>
        ...
        <div className="relative flex min-h-[520px] items-center justify-center lg:min-h-[650px]">
          ...
          <img
            ...
            className="absolute right-[32%] top-[8%] z-10 h-[430px] w-auto object-contain drop-shadow-[0_25px_30px_rgba(17,17,17,0.16)] rotate-[-3deg] transition-transform duration-500 hover:-translate-y-2"
          />
          ...
          <img
            ...
            className="absolute sm:right-[5%] right-[-18%] top-[3%] z-20 h-[540px] w-auto object-contain drop-shadow-[0_30px_35px_rgba(17,17,17,0.18)] rotate-[2deg] transition-transform duration-500 hover:-translate-y-2"
          />
